...
/** YlGnBu sequential — good for total voter counts */
...
/** Viridis sequential — good for mean age */
...
/** PiYG diverging — good for gender ratio (M:F) */
...
/**
 * All available choropleth metric options.
 */
